class Employee {
  ...
  const dev1 = new Developer("Дмитро", "Торгонський", 3000, 3);
  const dev2 = new Developer("Петро", "Кузьмич", 3200, 6);
  const des1 = new Designer("Олена", "Торгоній", 2800, 2, 0.9);
  const des2 = new Designer("Ольга", "Матвієнко", 2900, 7, 0.8);
  
  const manager1 = new Manager("Андрій", "Остапенко", 5000, 10);
